...
5. Select the range of cells that contain data need to be convert to 2 decimal places and click on the **"Format"**, and select **"Number"**.
<p align="center"><img align="center" alt="Coding" width="400" src="numberformat.png"></p>  

6. The data values was displayed in two decimal places.
<p align="center"><img align="center" alt="Table" width="400" src="numberformatdone.png"></p>  

7. Use formula **"=(B2/61*3.33)"** to update the new maximum value of 3.33, same procedure apply to column H **"(=C2/10*3.33)"**, I **"(=D2/15*3.33)"**, J **"(=E2/10*3.33)"**, and K **"(=F2/10*3.33)"** with different formula.
...
8. Use formula **"=LARGE(data,n)"** to find the highest, second highest and third highest value for column G to K.
...
9. Use formula **"=SUM(value1)"** to calculate the total point for column L to N.
...
10. Multiply the value in column O with 10 to calculate the percentage in column p.
...
13. Use **"Conditional Formatting"** to colour column P with green and colour the Pass line with a light red.
<p align="center">
